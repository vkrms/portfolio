const job = {
    ...
    text: `
            ...
            It's a tribute to the popular tv show and computer game.
            I did all of the back end with Laravel and later I've been passed full control and refactored some of the front-end features and animations.
    ...
    excerpt: `A responsive web game built on Vue.js and Laravel with some cool-loking animations.`,
    ...
    vids: [
        {
            linkText: 'Video demo',
            url: 'https://drive.google.com/file/d/1pp_R5wnC4LLUwUHTYOAoJgCVn5ea0FiW/view?usp=sharing',
        }
    ],
